...
extension EnvironmentValues {
    @Entry var gmailApiClient: GmailApiClient? = nil
}

protocol GmailApiClient {
    func perform<R: GmailApi.Request>(_ request: R) async throws -> R.ResponseType
}

// MARK: - Live Request Performer Implementation

class LiveGmailApiClient: GmailApiClient {
